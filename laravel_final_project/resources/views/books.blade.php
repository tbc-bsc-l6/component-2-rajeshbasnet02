<x-guest-layout>
    <section class="books__section">
        <div class="books__section__container">
            <div class="books__banner__image bg-cover bg-center flex items-center h-[75vh]"  style="background-image: url('/images/slider-books.jpg');">
                <div class="ml-36">
                    <h2 class="text-5xl font-extrabold leading-loose">Explore our books</h2>
                    <p class="text-xl">Books strengthen our self-confidence<br/> and help us to understand why we are who we are.  </p>
                    <br>
            ...
            @foreach($books[0]->product as $game__product)
                <div class="individual__product border-2 border-solid border-gray-200 w-full">
                    ...
                    <div class="flex items-baseline justify-end mx-4 mb-6">
                        <a href="/products/books/{{$game__product->id}}" class="text-gray-500 font-bold flex items-center">
                            Explore
