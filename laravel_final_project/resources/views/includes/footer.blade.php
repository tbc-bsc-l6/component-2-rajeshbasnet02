<footer>
    <div class="bg-gray-50 lg:pt-16 lg:pb-8 sm:pb-0 sm:pt-4">
        <div class="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
            ...
            <div class="p-5">
                ...
                <a class="my-3 block" href="/#">Thapathali, Kathmandu <span
                        class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#">aseng@tbc.edu.com
            ...
            <div class="p-4">
                ...
                <form method="post" action="/newsletter" class="flex mt-4">
                    ...
                    <button type="submit" style="z-index: 1;"
                            class="bg-indigo-600 text-white px-6 py-2 rounded-xl block translate-x-[-20px]">Subscribe
                    </button>
                </form>
